...
class ReporteOperaciones
{
	...
	public function listarPorFechaYbanco($operacion, $fecha_inicio, $fecha_fin)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
				...
				WHERE DATE(t.fecha_hora) >= '$fecha_inicio'
				AND DATE(t.fecha_hora) <= '$fecha_fin'
				AND o.titulo LIKE '%$operacion%'
				ORDER BY t.idticket DESC";
		return ejecutarConsulta($sql);
	}

	public function listarPorFechaYbancoUsuario($idusuario, $operacion, $fecha_inicio, $fecha_fin)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
	...
	public function listarPorOperacion($operacion)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
				...
				LEFT JOIN operaciones o ON t.idoperacion = o.idoperacion
				LEFT JOIN locales l ON t.idlocal = l.idlocal
				WHERE o.titulo LIKE '%$operacion%'
				ORDER BY t.idticket DESC";
		return ejecutarConsulta($sql);
	}

	public function listarPorOperacionUsuario($idusuario, $operacion)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
