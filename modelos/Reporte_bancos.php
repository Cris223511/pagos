...
class ReporteBancos
{
	...
	public function listarPorFechaYbanco($banco, $fecha_inicio, $fecha_fin)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
				...
				WHERE DATE(t.fecha_hora) >= '$fecha_inicio'
				AND DATE(t.fecha_hora) <= '$fecha_fin'
				AND b.titulo LIKE '%$banco%'
				ORDER BY t.idticket DESC";
		return ejecutarConsulta($sql);
	}

	public function listarPorFechaYbancoUsuario($idusuario, $banco, $fecha_inicio, $fecha_fin)
	{
		$sql = "SELECT
				  t.idticket,
				  u.nombre as usuario,
