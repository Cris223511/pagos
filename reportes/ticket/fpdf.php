...
class FPDF
{
	...
	function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
	{
		...
		if (defined('FPDF_FONTPATH')) {
			...
			$this->fontpath = '';
		// Core fonts
		$this->CoreFonts = array('courier', 'roboto-regular', 'roboto-bold', 'helvetica', 'times', 'symbol', 'zapfdingbats');
		// Scale factor
		if ($unit == 'pt')
			$this->k = 1;
		elseif ($unit == 'mm')
	...
	function encabezado($usuario, $banco, $operacion, $local, $local_ruc, $num_ticket, $num_ope, $date)
	{
		# N° TICKET #
		$this->SetXY(1.5, 2);
		$this->SetFont('roboto-regular', '', 5.5);
