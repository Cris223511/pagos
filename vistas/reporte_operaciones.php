...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Reporte de tickets por operación
              ...
              <div class="panel-body table-responsive" id="listadoregistros" style="overflow-x: visible; padding-left: 0px; padding-right: 0px;">
                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <select id="idoperacion" name="idoperacion" class="form-control selectpicker" data-live-search="true" data-size="5">
                ...
                <div style="display: flex; gap: 10px; padding: 15px; padding-top: 0px; padding-bottom: 0px;">
                  <button style="margin-top: 10px;" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 btn btn-warning" id="buscarPorOperacion" onclick="buscarPorOperacion()">Buscar por operación</button>
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/reporte_operaciones2.js"></script>
<?php
}
ob_end_flush();
?>