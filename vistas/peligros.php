...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Peligros
                  <?php
                  if ($_SESSION['cargo'] == 'jefe_sst') {
                  ?>
                  ...
                  ?>
                  <a href="../reportes/rptpeligros.php" target="_blank">
              ...
              <div class="panel-body" style="height: max-content;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <label>Peligro (*):</label>
                    <input type="hidden" name="idpeligro" id="idpeligro">
                    <input type="text" class="form-control" name="titulo" id="titulo" maxlength="50" placeholder="Ingrese el peligro." required>
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/peligros1.js"></script>
<?php
}
ob_end_flush();
?>