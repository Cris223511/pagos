						...
						$data[] = array(
							"0" => '<div style="display: flex; flex-wrap: nowrap; gap: 3px">' .
								(($reg->estado == 'activado') ?
									...
									(('<button class="btn btn-danger" style="width: 35px; height: 35px;" onclick="eliminar(' . $reg->idticket . ')"><i class="fa fa-trash"></i></button>')) : (('<button class="btn btn-bcp" style="margin-right: 3px; width: 35px; height: 35px;" onclick="detalles(' . $reg->idticket . ')"><i style="margin-left: -1px" class="fa fa-eye"></i></button>')) .
